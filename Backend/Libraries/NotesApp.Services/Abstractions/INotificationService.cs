...
namespace NotesApp.Services.Abstractions
{
    public interface INotificationService
    {
        ...
        Task<Guid> CreateNoteAsync(NotificationCreateDto notificationCreateDto, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        Task<bool> UpdateNoteAsync(NotificationUpdateDto notificationUpdateDto, CancellationToken cancellationToken = default);
        /// <summary>
        /// Удаление заметки.
        /// </summary>
